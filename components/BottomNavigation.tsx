...
export function BottomNavigation() {
  ...
  return (
    <nav
      aria-label="Primary"
      className="fixed inset-x-0 bottom-0 z-40 border-t border-white/5 bg-gray-950/90 backdrop-blur supports-[backdrop-filter]:bg-gray-950/70"
    >
          ...
          return (
            <li key={href} className="flex-1">
              <Link
                ...
                className={`group flex w-full flex-col items-center gap-1 rounded-xl px-2 py-2 text-xs transition-all duration-200 active:scale-95 ${
                  active
